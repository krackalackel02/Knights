...
import { knightMoves, convert } from "../features/Knight/knight";
function Buttons() {
	...
	return (
		<div className="btn-grid">
			<div className="btn-group">
				<button
					className={`btn btn-position start ${
						state.activeButton == "start" ? "Selected" : ""
					}`}
					onClick={(e) => {
				...
				<button
					className={`btn btn-position target ${
						state.activeButton == "target" ? "Selected" : ""
					}`}
					onClick={(e) => {
